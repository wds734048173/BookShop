...
<div class="modal-body">
    <div class="form-group">
        ...
        <input type="text" class="form-control" id="orderNo" name="orderNo" value="<%=order.getId()%>">
    </div>
    <div class="form-group">
        <label for="price" class="control-label">商品原价:</label>
        <input type="text" class="form-control" id="price" name="price" value="<%=order.getPrice()%>">
    </div>
    <div class="form-group">
        <label for="freight" class="control-label">运费:</label>
        <input type="text" class="form-control" id="freight" name="freight" value="<%=order.getFreight()%>">
    </div>
    <div class="form-group">
        <label for="money" class="control-label">商品实付金额:</label>
        <input type="text" class="form-control" id="money" name="money" value="<%=order.getMoney()%>">
    </div>
    <div class="form-group">
        <label for="stateStr" class="control-label">状态:</label>
        <input type="text" class="form-control" id="stateStr" name="stateStr" value="<%=order.getStateStr()%>">
    </div>
    <div class="form-group">
        <label for="ctime" class="control-label">创建时间:</label>
        <input type="text" class="form-control" id="ctime" name="ctime" value="<%=order.getCtime()%>">
    </div>
    <div class="form-group">
        <label for="rtime" class="control-label">修改时间:</label>
        <input type="text" class="form-control" id="rtime" name="rtime" value="<%=order.getRtime()%>">
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control" id="phone" name="phone" value="<%=order.getPhone()%>">
    </div>
    <div class="form-group">
        <label for="address" class="control-label">收货人地址:</label>
        <input type="text" class="form-control" id="address" name="address" value="<%=order.getAddress()%>">
    </div>
</div>
<div class="modal-body">
